...
public class ComparatorTester {
	...
	public void test01(){
		...
		//assertEquals(1, Animal.getAnimalComp(topPredator, primaryPredator));
	}
	...
	public void test02(){
		...
		//assertEquals(-1, Animal.getAnimalComp());
	}
	...
	public void test03(){
		...
		//assertTrue(Animal.getAnimalComp(topPredator, unrelatedPredator) > 0);
	}
	...
	public void test04(){
		...
		//assertTrue(Animal.getAnimalComp(primaryPredator, unrelatedPredator) < 0);
	}
	...
	public void test05(){
		...
		//assertEquals(0, Animal.getAnimalComp(primaryPredator, primaryPredator));
	}
	...
	public void test09(){
		...
		//assertEquals(1, Animal.getAnimalComp(primaryPredator, herb1));
	}
	...
	public void test10(){
		...
		//assertTrue(Animal.getAnimalComp(topPredator, herb1) > 0);
	...
	public void test11(){
		...
		//assertTrue(Animal.getAnimalComp(herb1, primaryPredator) < 0);
	}
	...
	public void test12(){
		...
		//assertTrue(Animal.getAnimalComp(herb1, topPredator) < 0);
	}
